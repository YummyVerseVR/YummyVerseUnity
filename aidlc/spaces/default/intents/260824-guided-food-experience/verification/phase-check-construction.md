...
- [x] v2 HTTP path/auth/download was not inferred.
...
`Q1`〜`Q11`、normative v2 HTTP operations、scene/device-specific decisions が未解決であるため、Construction phase 全体を完了扱いにせず、Operation へ進めない。
